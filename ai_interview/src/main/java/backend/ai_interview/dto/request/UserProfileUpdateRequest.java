 ...
 *
 * DTO used to update a user's profile.
 * This allows manual editing of profile data that may have
 * originally been extracted from the resume.
 */
...
public class UserProfileUpdateRequest {
    ...
    @Size(max = 200, message = "Current role must not exceed 200 characters")
    private String currentRole;

    @Size(max = 300, message = "Highest education must not exceed 300 characters")
    ...
    /**
     * JSON string containing top skills extracted from resume
     * Example:
